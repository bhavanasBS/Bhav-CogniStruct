...
const ManagerDashboard = () => {
    ...
    const user = authCtx?.user || { userId: 1, firstName: 'Manager' };
    ...
    return (
        <div className="space-y-6">
            {/* Header */}
            <div className="bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-500 rounded-2xl p-6 text-white relative overflow-hidden">
                ...
                <Card className="lg:col-span-2">
                    <div className="px-6 py-4 border-b border-slate-200">
                        <div className="flex items-center justify-between">
                            ...
                            <Badge variant="info">{teamReports.length} Teams</Badge>
                        </div>
                    </div>
                    <div className="p-4">
                        {teamReports.length === 0 ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                                {teamReports.map((team) => (
                                    <div
                                        key={team.id}
                                        className="bg-slate-50 rounded-xl p-4 hover:shadow-md transition-all cursor-pointer border border-slate-100 hover:border-indigo-200"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <button
                    ...
                    className="bg-white border border-slate-200 rounded-xl p-4 hover:shadow-md hover:border-indigo-200 transition-all flex items-center gap-3 cursor-pointer group"
                >
                    ...
                    <ArrowUpRight className="w-4 h-4 text-slate-300 ml-auto group-hover:text-indigo-500 transition-colors" />
                </button>
                <button
                    onClick={() => navigate('/manager/team')}
                    className="bg-white border border-slate-200 rounded-xl p-4 hover:shadow-md hover:border-indigo-200 transition-all flex items-center gap-3 cursor-pointer group"
                ...
                >
                    ...
                    <div className="text-left">
                        ...
                        <p className="text-xs text-slate-400">View detailed reports</p>
                    </div>
