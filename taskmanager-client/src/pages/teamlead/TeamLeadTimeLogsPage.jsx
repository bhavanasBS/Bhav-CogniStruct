...
const TeamLeadTimeLogsPage = () => {
    ...
    const fetchLogs = async () => {
        try {
            ...
            const leadId = user.id || user.userId;
            // Use team endpoint to get all team member logs
            const response = await workLogApi.getByTeam(leadId);
    ...
    return (
        <div className="space-y-6">
            {/* Header — Teal/Emerald gradient to differentiate from Manager (blue) and Employee (amber) */}
            <div className="bg-gradient-to-r from-teal-500 via-emerald-500 to-green-500 rounded-2xl p-6 text-white relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-white/80 text-sm mt-0.5">Track and review your team's logged hours</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full">
                        <thead className="bg-slate-50">
                            <tr>
                                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-500 uppercase whitespace-nowrap">Member</th>
                            ...
                            {isLoading ? (
                                ...
                                logs.map((log) => (
                                    <tr key={log.id || log.workLogId} className="hover:bg-slate-50">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className="px-2 py-1 bg-teal-50 text-teal-700 rounded-lg text-sm font-medium">
...
export default TeamLeadTimeLogsPage;
